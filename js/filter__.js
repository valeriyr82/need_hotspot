...
app.controller('filterCtrl', function(myService, $scope) {
	...
	myService.async().then(function(d) {
		...
		for(i = 0; i < $scope.data.output_asArray.length; i++) {
			if(typeof tmpHash[$scope.data.output_asArray[i]._style] == 'undefined') {
				var woodStyle = {text: $scope.data.output_asArray[i]._style, selected: false, count: 0, src: $scope.data.output_asArray[i]._src};
				$scope.woodStyles.push(woodStyle);
				$scope.woodStylesCol[$scope.data.output_asArray[i]._style] = woodStyle;

				tmpHash[$scope.data.output_asArray[i]._style] = true;
			}
			for( j = 0; j < $scope.data.output_asArray[i].woodtype_asArray.length; j++) {
				if(typeof tmpHash2[$scope.data.output_asArray[i].woodtype_asArray[j]._name] == 'undefined') {
					var woodType = {text: $scope.data.output_asArray[i].woodtype_asArray[j]._name, selected: false, count: 0, src: $scope.data.output_asArray[i].woodtype_asArray[j]._src};
					$scope.woodTypes.push(woodType);
					$scope.woodTypesCol[$scope.data.output_asArray[i].woodtype_asArray[j]._name] = woodType;
					
					tmpHash2[$scope.data.output_asArray[i].woodtype_asArray[j]._name] = true;
				}
				for( k = 0; k < $scope.data.output_asArray[i].woodtype_asArray[j].color_asArray.length; k++) {
					if(typeof tmpHash3[$scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k]._name] == 'undefined') {
						var woodColor = {text: $scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k]._name, selected: false, count: 0, src: $scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k]._src};
						$scope.woodColors.push(woodColor);
						$scope.woodColorsCol[$scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k]._name] = woodColor;
						
						tmpHash3[$scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k]._name] = true;						
					}
					if($scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k].img_asArray) {
						angular.forEach($scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k].img_asArray, function(image, index){
							image.collection = $scope.data.output_asArray[i]._name;
							image.type = $scope.data.output_asArray[i].woodtype_asArray[j]._name;
							image.color = $scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k]._name;
						});
						$scope.imageCollection = $scope.imageCollection.concat($scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k].img_asArray);

						$scope.pannel.count += $scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k].img_asArray.length;
						$scope.pannel.totalcount += $scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k].img_asArray.length;

						$scope.woodStylesCol[$scope.data.output_asArray[i]._style].count += $scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k].img_asArray.length;
						$scope.woodTypesCol[$scope.data.output_asArray[i].woodtype_asArray[j]._name].count += $scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k].img_asArray.length;
						$scope.woodColorsCol[$scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k]._name].count += $scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k].img_asArray.length;

						$scope.woodStyles[0].count += $scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k].img_asArray.length;
						$scope.woodTypes[0].count += $scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k].img_asArray.length;
						$scope.woodColors[0].count += $scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k].img_asArray.length;
					}
				}
			}
			...
			if($scope.data.hotspots_asArray[0].img_asArray) {
				angular.forEach($scope.data.hotspots_asArray[0].img_asArray, function(room, i){
					if ( typeof $scope.learnCollection[room._room] != "object") {
						$scope.learnCollection[room._room] = {text: room._room, selected: false, collection: [], priority: parseInt(room._priority)};
					}
	...
	$scope.updateFilter = function(targetContainer, target) {
		...
		for(i = 0; i < $scope.data.output_asArray.length; i++) {
			if($scope.woodStyles[0].selected == true || $scope.woodStylesCol[$scope.data.output_asArray[i]._style].selected == true) {
				for( j = 0; j < $scope.data.output_asArray[i].woodtype_asArray.length; j++) {
					if(typeof tmpHash2[$scope.data.output_asArray[i].woodtype_asArray[j]._name] == 'undefined') {
						$scope.woodTypes.push($scope.woodTypesCol[$scope.data.output_asArray[i].woodtype_asArray[j]._name]);
						tmpHash2[$scope.data.output_asArray[i].woodtype_asArray[j]._name] = true;
						if($scope.woodTypesCol[$scope.data.output_asArray[i].woodtype_asArray[j]._name].selected) {
		...
		for(i = 0; i < $scope.data.output_asArray.length; i++) {
			if($scope.woodStyles[0].selected == true || $scope.woodStylesCol[$scope.data.output_asArray[i]._style].selected == true) {
				for( j = 0; j < $scope.data.output_asArray[i].woodtype_asArray.length; j++) {
					if($scope.woodTypes[0].selected == true || $scope.woodTypesCol[$scope.data.output_asArray[i].woodtype_asArray[j]._name].selected == true) {
						for( k = 0; k < $scope.data.output_asArray[i].woodtype_asArray[j].color_asArray.length; k++) {
							if(typeof tmpHash3[$scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k]._name] == 'undefined') {
								$scope.woodColors.push($scope.woodColorsCol[$scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k]._name]);
								tmpHash3[$scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k]._name] = true;
								if($scope.woodColorsCol[$scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k]._name].selected == true) {
									isSelectedExist = true;
								}
							}
						}
		...
		/*for(i = 0; i < $scope.data.output_asArray.length; i++) {
			if($scope.woodStyles[0].selected == true || $scope.woodStylesCol[$scope.data.output_asArray[i]._style].selected == true) {
				for( j = 0; j < $scope.data.output_asArray[i].woodtype_asArray.length; j++) {
					if($scope.woodTypes[0].selected == true || $scope.woodTypesCol[$scope.data.output_asArray[i].woodtype_asArray[j]._name].selected == true) {
						for( k = 0; k < $scope.data.output_asArray[i].woodtype_asArray[j].color_asArray.length; k++) {
							if($scope.woodColors[0].selected == true || $scope.woodColorsCol[$scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k]._name].selected == true) {
			...
			if($scope.woodCollections[l].selected == true) {
				...
				for( j = 0; j < $scope.data.output_asArray[i].woodtype_asArray.length; j++) {
					for( k = 0; k < $scope.data.output_asArray[i].woodtype_asArray[j].color_asArray.length; k++) {
						if($scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k].img_asArray) {
							$scope.imageCollection = $scope.imageCollection.concat($scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k].img_asArray);
							imgCount += $scope.data.output_asArray[i].woodtype_asArray[j].color_asArray[k].img_asArray.length;
						}
					}
				}
	...
	$scope.updateImageByRoom = function(room) {
		...
		angular.forEach($scope.data.output_asArray, function(output, i){
			angular.forEach(output.woodtype_asArray, function(woodtype, j){
	...
	function updateTopInfoBlock(idx) {
		if(typeof idx == "number" && parseInt(idx) >= 0) {
			$scope.topInfoBlock.title = $scope.data.output_asArray[idx]._name;
			$scope.topInfoBlock.description = $scope.data.output_asArray[idx]._description;
				...
				angular.forEach(image.spot_asArray, function (spot, index) {
					sliderContent +=
						' <div class="xyHot" style="position:absolute;left:' + spot._left +
							';top:' + spot._top +
							';z-index:8888;cursor:pointer;" show="hotimage.jpg" description="' + spot._text +
							'"><img src="images/check.png"></div>';
				})
			}

			sliderContent += 	'<img class="slideImg" src="images/'+image._src+'" collection="'+image.collection+'" species="'+image.type+'" color="'+image.color+'" alt="" />';
			sliderContent += '</div>';
		});
		if($scope.imageCollection.length > 0) {
			if ($scope.imageCollection[0].collection) {
				updateTopInfoBlock($scope.woodCollectionsCol[$scope.imageCollection[0].collection].index);
			}
		} else {
			clearTopInfoBlock();
		}
		$('#sliderLodingNoticication').show();
		setTimeout(function(){$('#sliderLodingNoticication').hide();}, 500);
			...
			if ( coll != "undefined") {
				if(window.control == 0 && $('#full-width-slider .rsContent').length > 1) {
					window.currentDown.slideUp(function(){
						$scope.$apply(updateTopInfoBlock($scope.woodCollectionsCol[coll].index));
					});
					$('#pom').attr({ 'src': 'images/plus.png' });
					current.slideDown();
